# -*- coding: utf-8 -*-
"""new_Q+Rf+temp+if_LSTM

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/10HV7IaVMUqGTujjcNveWiBJ4PKtqgiS1
"""
...
for day in [1,2,3]:
  ...
  history = model_lstm.fit(x_train, y_train, validation_data=(x_val, y_val), epochs=70,batch_size=32, verbose=2)
  ...
  #predictions
  train_yp = model_lstm.predict(x_train.reshape(len(x_train),1, x_train.shape[2],1))
  val_yp = model_lstm.predict(x_val.reshape(len(x_val),1, x_val.shape[2], 1))
  test_yp = model_lstm.predict(x_test.reshape(len(x_test),1, x_test.shape[2],1))
  ...
  #to save as csv file
  dataset.to_csv(f'/content/drive/MyDrive/new_ACF/LSTM/Q+rf+temp+if/lead_day_{day}_lstm_train_day.csv')
  ...
  dataset_test.to_csv(f'/content/drive/MyDrive/new_ACF/LSTM/Q+rf+temp+if/lead_day_{day}_lstm_test_day.csv')
  ...
  res['Stats'] = names
  res['Values'] = results
  res.to_csv(f'/content/drive/MyDrive/new_ACF/LSTM/Q+rf+temp+if/lead_day_{day}_lstm_result_day.csv')
