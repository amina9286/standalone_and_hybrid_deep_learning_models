# -*- coding: utf-8 -*-
"""new_Q+rf+temp+if_CNN-LSTM

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wHGvsdJE-Eyjhy5v3HwU_zapmOb_JK4A
"""
...
for day in [1,2,3]:
  ...
  history = model.fit(x_train.reshape(len(x_train), 1, x_train.shape[2], 1) ,y_train, batch_size=128, epochs=80, verbose=1,validation_data=(x_val, y_val))
  ...
  #to save as csv file
  dataset.to_csv(f'/content/drive/MyDrive/new_ACF/CNN_LSTM/Q+rf+temp+if/lead_day_{day}_cnn_lstm_train_day.csv')
  ...
  dataset_test.to_csv(f'/content/drive/MyDrive/new_ACF/CNN_LSTM/Q+rf+temp+if/lead_day_{day}_cnn_lstm_test_day.csv')
  ...
  res['Stats'] = names
  res['Values'] = results
  res.to_csv(f'/content/drive/MyDrive/new_ACF/CNN_LSTM/Q+rf+temp+if/lead_day_{day}_cnn_lstm_result_day.csv')
