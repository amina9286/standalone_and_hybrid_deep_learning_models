# -*- coding: utf-8 -*-
"""new_Q+Rf+temp+if_CNN

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_TnerFppWMI0GKOFfCNlhQ-qFeX3INn7
"""
...
for day in [1,2,3]:
  ...
  #to save as csv file
  dataset.to_csv(f'/content/drive/MyDrive/new_ACF/CNN/Q+rf+temp+if/lead_day_{day}_cnn_train_day.csv')
  ...
  dataset_test.to_csv(f'/content/drive/MyDrive/new_ACF/CNN/Q+rf+temp+if/lead_day_{day}_cnn_test_day.csv')
  ...
  res['Stats'] = names
  res['Values'] = results
  res.to_csv(f'/content/drive/MyDrive/new_ACF/CNN/Q+rf+temp+if/lead_day_{day}_cnn_result_day.csv')
